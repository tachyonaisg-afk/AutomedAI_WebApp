    ...
    const fetchQueueNumber = async () => {
      try {
        ...
        const response = await api.get(
          `https://midl.automedai.in/appointments/queue/${appointmentId}`
        );
          ...
          <PrescriptionPreview data-pdf-content paperSize={paperSize}>
            <PrescriptionHeader>
              ...
              <HeaderAddress paperSize={paperSize}>
                P.0 - Sargachi Ashrama, Dist- Murshidabad, Pin-742408, West Bengal, India, Phone : (03482) 232301
              </HeaderAddress>
            </PrescriptionHeader>
            ...
            <TopRow>
              ...
              <TicketInfo paperSize={paperSize}>
                ...
                <div style={{fontSize:"5px"}}>[Generated by : {currentUser}]<br /></div>
              </TicketInfo>
            </TopRow>
